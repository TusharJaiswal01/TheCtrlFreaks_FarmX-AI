...
const PlantDiseasePredictor = () => {
  ...
  return (
    <>
      <div className="w-full h-full bg-fixed bg-cover bg-center   bg-[url(crop.jpeg.jpg)] ">
        ...
        <div className="flex flex-col items-center content-center mt-6">
          ...
          <div className="flex mt-10 w-full flex-col font-bold ">
            ...
            <div className="flex w-full h-full justify-center mb-8" >
              ...
              <div className=" flex items-center bg-white/10 backdrop-blur-xl mt-4 shadow-lg rounded-lg pr-4 pl-4 p-2">
            ...
            <div className="w-full px-4 flex flex-col md:flex-row justify-between">
              {/* Image Section */}
              <div className="flex flex-col   bg-white/10 backdrop-blur-lg border-4 border-white shadow-lg
        p-4 rounded-3xl items-center md:w-1/3">


                <img
                  className="h-48 sm:h-72 w-[90%] z-10 object-cover rounded mb-4 border-4"
                  src="upload.jpg"
                  alt="content"
                />

                <input
                  className="block w-[92%] text-sm text-white border border-gray-300 cursor-pointer rounded-full bg-gradient-to-r from-green-800 via-green-400 to-green-700 dark:text-gray-100 focus:outline-none dark:bg-gray-700 dark:border-gray-600"
                  type="file"
                  onChange={handleImageUpload}
                />
                <h1 className="text-center mt-4 text-xl font-semibold text-white">
                  Upload Your Crop Image Here
                </h1>
              </div>

              {/* Prediction Section */}
              <div className="flex flex-col items-center justify-evenly mt-6 md:mt-0 md:w-1/3">
                {loading ? (
                  <Loader />
                ) : (
             <div className="text-xl sm:text-2xl font-extrabold py-2 px-2 mt-12 bg-green-600 w-80 h-fit break-words whitespace-normal rounded-xl text-gray-900 dark:text-white">
             Crop Status: {plantstate[prediction]}
                </div>

                )}
                 <Link to="/Monitoring" className=" flex  items-center justify-center  text-right w-64 h-14 text-xl bg-green-600 text-white mt-10 rounded-2xl ">
                 <Typewriter
            words={[' Intrusion Monitoring']}
            loop={0}
            cursor
            cursorStyle='_'
            typeSpeed={70}
          ...
          />
                ...
                {/* <FaArrowRightLong className="text-2xl  ml-4"/> */}
              </Link>
              </div>

              {/* AI Generated Box */}
              <div className="bg-white/10 backdrop-blur-lg border-4 border-white shadow-lg p-4 mt-6 md:mt-0 rounded-3xl md:w-1/3">
                <div className=" flex flex-col   h-96 align-middle items-center container px-4">
                  <img className=" h-40 w-40 mt-4" src="tree.png" alt="" />
                  <button
                    onClick={handleGenerate}
                    className="px-6 py-2  text-xl rounded-full bg-green-600 text-white "
                    disabled={loading}
                  >
                  ...
                  {aiData && (
                    <div className="border p-4  overflow-y-scroll   mt-5 rounded-md shadow-md bg-[#fdff8a] max-w-96 ">
